...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.videHolderIndexTextView.setText("ViewHolder index: "+viewHolderCount);
        ...
        viewHolderCount++;
        Log.d(this.toString(), "viewHolderCount :"+viewHolderCount);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView videHolderIndexTextView;
        ...
        public NumberViewHolder(View itemView) {
            ...
            videHolderIndexTextView=(TextView)itemView.findViewById(R.id.tv_view_holder_instance);
            // cmmpleted (11) Use itemView.findViewById to get a reference to tv_view_holder_instance
        }
